...
现在，你可以解放双手，安装同 `use-upgrade` 配套发布的 Agent Skills，让 AI 编程助手来帮你集成它！<br />
了解 [`use-upgrade` 的 Agent Skills](https://use-upgrade.paperplane.cc/guide/bootstrap/agent-skills)。

---

`use-upgrade` 可在零配置的情况下开箱即用，兼容 Vite、Webpack、Next.js 等构建系统的各类项目（React、Vue、Angular、Svelte 等）。
